...
public class GeolocationModule extends WXModule implements Destroyable {
    ...
    public void getCurrentPosition(String successCallback, String errorCallback, String params) {
        ...
        if (checkPermission()) {
            ...
            requestPermission(successCallback, errorCallback, params,
                    ILocatable.REQUEST_CUR_PERMISSION_CODE);
        }
    }
    ...
    public void watchPosition(String successCallback, String errorCallback, String params) {
        ...
        if (checkPermission()) {
            ...
            requestPermission(successCallback, errorCallback, params,
                    ILocatable.REQUEST_WATCH_PERMISSION_CODE);
        }
    }
    ...
    private void requestPermission(String successCallback, String errorCallback, String params,
        ...
        ActivityCompat.requestPermissions((Activity) mWXSDKInstance.getContext(),
                new String[]{Manifest.permission.ACCESS_FINE_LOCATION,
                        Manifest.permission.ACCESS_COARSE_LOCATION}, requestCurPermissionCode);
        LocalBroadcastManager.getInstance(mWXSDKInstance.getContext())
                .registerReceiver(new PerReceiver(mWXSDKInstance.getInstanceId(), mILocatable,
    ...
    static class PerReceiver extends BroadcastReceiver {
        ...
        PerReceiver(String instanceId, ILocatable locatable, String successCallback,
                    String errorCallback, String params) {
